...
const CreateDailyLog = () => {
  ...
  const handleSubmit = async (values, { setSubmitting }) => {
    try {
      ...
      if (photos.length > 0) {
        ...
        await fileService.uploadPhoto(logId, photoFormData);
      }
      ...
      if (documents.length > 0) {
        ...
        await fileService.uploadDocument(logId, documentFormData);
      }
  ...
  return (
    <Container>
      <Row className="mb-4">
        <Col>
          <h2>Create Daily Work Log</h2>
          <p className="text-muted">Fill in the details of today's work</p>
        </Col>
      </Row>
                  ...
                  <Col md={6}>
                    <Form.Group>
                      ...
                      <Form.Text className="text-muted">
                        Upload photos of the work site and completed tasks
                      </Form.Text>
                    </Form.Group>
                  </Col>
                  <Col md={6}>
                    <Form.Group>
                      ...
                      />
                      <Form.Text className="text-muted">
                        Upload delivery notes, receipts, invoices, etc.
                      </Form.Text>
                    </Form.Group>
                  </Col>
                </Row>
